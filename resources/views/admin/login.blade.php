					...
					<div class="d-table-cell align-middle">
						...
						<div class="text-center mt-4">
                            ...
                            @if (session()->has('login') && session('login') == 'failed')
                                <div class="alert alert-warning" id="infoMessage"><span>Giriş başarısız</span></div>
                            @endif
						<div class="card">
							<div class="card-body">
								<div class="m-sm-3">
									<form action="{{ route('giris') }}" method="post" accept-charset="utf-8">
                                    @csrf
										<div class="mb-3">
										...
										<div class="d-grid gap-2 mt-3">
                                            ...
                                            value="Giriş Yapın!" class="btn btn-lg btn-primary" />
										</div>
									</form>
								</div>
							</div>
